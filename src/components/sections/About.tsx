          ...
          <div>
            <AnimatedSection direction="left" threshold={0.2}>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">
                Founded in 2023, EasyIo.tech is built on the belief that simplicity drives innovation. We're dedicated to making technology more accessible, sustainable, and meaningful for everyone - from turning bold ideas into reality to helping businesses run smarter and students think like innovators.
              </p>
            </AnimatedSection>
            <div className="space-y-6">
              <AnimatedSection direction="left" delay={200} threshold={0.2}>
                <div className="flex items-center space-x-4 group hover:bg-purple-50 dark:hover:bg-purple-900/20 p-3 rounded-lg transition-colors duration-300">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-gray-100 group-hover:text-purple-700 dark:group-hover:text-purple-400 transition-colors duration-300">Innovation & Simplicity</h3>
                    <p className="text-gray-600 dark:text-gray-400">Cutting through complexity to build tools that work beautifully</p>
                  </div>
                </div>
              </AnimatedSection>
              <AnimatedSection direction="left" delay={400} threshold={0.2}>
                <div className="flex items-center space-x-4 group hover:bg-blue-50 dark:hover:bg-blue-900/20 p-3 rounded-lg transition-colors duration-300">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-gray-100 group-hover:text-blue-700 dark:group-hover:text-blue-400 transition-colors duration-300">Sustainability Focus</h3>
                    <p className="text-gray-600 dark:text-gray-400">Technology that's kind to the planet and meaningful for the future</p>
                  </div>
                </div>
              </AnimatedSection>
              <AnimatedSection direction="left" delay={600} threshold={0.2}>
                <div className="flex items-center space-x-4 group hover:bg-yellow-50 dark:hover:bg-yellow-900/20 p-3 rounded-lg transition-colors duration-300">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-gray-100 group-hover:text-yellow-700 dark:group-hover:text-yellow-400 transition-colors duration-300">Creative Partnership</h3>
                    <p className="text-gray-600 dark:text-gray-400">Your creative tech partner in shaping the future</p>
                  </div>
                </div>
              </AnimatedSection>
            </div>
