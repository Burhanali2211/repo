    ...
    <div className="container mx-auto px-4 md:px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
        <motion.div
          ...
          className="bg-gray-100 dark:bg-white/10 backdrop-blur-sm rounded-xl p-8 text-center shadow-md dark:shadow-none hover:bg-gray-200 dark:hover:bg-white/20 transition-all duration-500 group relative overflow-hidden"
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-700 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white transition-colors duration-300">Projects Completed</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-700 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white transition-colors duration-300">24/7 Support Team</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-700 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white transition-colors duration-300">100% Satisfaction Guarantee</p>
          </div>
        </motion.div>
      </div>
    </div>
